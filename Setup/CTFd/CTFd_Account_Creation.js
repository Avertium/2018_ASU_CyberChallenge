...
// @match        https://10.1.4.126/admin/teams
// @grant        none
// ==/UserScript==

(function() {
    'use strict';
    // Log to console to show the script is working
    console.log("CTFd User/Team Account Generator Loaded");
    // Append a button to the page to allow for user to activate when ready
    ...
    // This function loops through all of the teamnames and creates a new user account with the corresponding password
    function massCreate(){
    ...
    // This function creates a clone of the standard user account form, once each for each account being created
    function createUser(nonce, name, password){
        ...
        var settings = {
            "async": true,
            "crossDomain": true,
            "url": "https://10.1.4.126/admin/team/new", // The URL here would need to be modified depending on the host
            "method": "POST",
            "headers": {},
            "processData": false,
            "contentType": false,
        ...
        $.ajax(settings).done(function (response) {
            // This will return success or fail back to the console
            console.log(response);
        });
    }

    // Add the massCreate function to the click of the newly added button
